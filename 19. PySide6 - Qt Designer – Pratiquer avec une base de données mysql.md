...
C’est ce qui permet à ton interface de **réagir aux actions de l’utilisateur**.
...
Imagine un **interrupteur de lumière** :
...
Tu dois **relier le fil entre l’interrupteur et la lampe**. C’est ce que fait `.connect()`.
