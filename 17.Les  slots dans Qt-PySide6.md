...
# Annexe 1 - <h1 id="signaux-complets">Liste complète des signaux (slots attendus) par widget PySide6</h1>
...
# Annexe 2 - <h1 id="signaux-courants">Signaux courants des widgets PySide6</h1>
